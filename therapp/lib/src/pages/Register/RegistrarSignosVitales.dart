...
@override
  void initState() {
    ...
    _pesoController = new TextEditingController(text: widget.signosVitales.peso.toString());
    _tallaController = new TextEditingController(text: widget.signosVitales.talla.toString());
                    ...
                    onPressed: (){
                      if(widget.signosVitales.id!=null){
                        signosVitalesReference.child(widget.signosVitales.id).set({
                          ...
                          'frecuencia respiratoria': frecuenciaRespiratoryActual,
                          'peso': peso,
                          'talla': talla,
  ...
  '15 - 20'
   ...
   Widget pesoOption(){
    return DropdownButton<double>(
      ...
      items: pesos()
          .map<DropdownMenuItem<double>>((dynamic value) {
