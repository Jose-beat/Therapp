...
class ResAntecedentesFamiliares extends StatefulWidget {
  ...
  ResAntecedentesFamiliares({Key key, this.antecedentesFamiliares})
      : super(key: key);

  @override
  _ResAntecedentesFamiliaresState createState() =>
      _ResAntecedentesFamiliaresState();
}

final antecedentesFamiliaresReference =
    FirebaseDatabase.instance.reference().child('antecedentes_familiares');
